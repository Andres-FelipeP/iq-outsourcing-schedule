"""
Django settings for descanso_empleados project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Si dejas vacío, usará las plantillas dentro de las apps
        'APP_DIRS': True,  # Esto permite buscar automáticamente en las carpetas 'templates' de las apps
        'OPTIONS': {
            'context_processors': [
